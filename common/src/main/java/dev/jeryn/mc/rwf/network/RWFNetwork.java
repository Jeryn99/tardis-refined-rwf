...
public class RWFNetwork {
    ...
    public static MessageType TARDIS_PHYSICS_UPDATE, SYNC_TARDIS_PHYSICS, SET_FREEFALL, START_RWF, OPEN_RWF, STOP_RWF, VORTEX_TRANSITION, SYNC_FLIGHT_DATA, LOCAL_HOP;
    ...
    public static void init() {
        ...
        LOCAL_HOP = NETWORK.registerC2S("local_hop", LocalHopMessage::new);
    }
}